...
import {
  ...
  type TickEvent,
  type TracesGetParams,
  TracesGetParamsSchema,
  type TracesTailParams,
  TracesTailParamsSchema,
  type TracesTailResult,
  TracesTailResultSchema,
  TickEventSchema,
...
export const validateTracesTailParams = ajv.compile<TracesTailParams>(TracesTailParamsSchema);
export const validateTracesGetParams = ajv.compile<TracesGetParams>(TracesGetParamsSchema);
