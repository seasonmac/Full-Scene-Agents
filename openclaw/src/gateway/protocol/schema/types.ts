...
export type LlmTraceSummary = SchemaType<"LlmTraceSummary">;
export type LlmTraceRecord = SchemaType<"LlmTraceRecord">;
export type TracesTailParams = SchemaType<"TracesTailParams">;
export type TracesTailResult = SchemaType<"TracesTailResult">;
export type TracesGetParams = SchemaType<"TracesGetParams">;
