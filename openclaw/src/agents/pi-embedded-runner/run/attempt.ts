...
import { createLlmTraceRecorder } from "../../../infra/llm-traces.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    try {
      ...
      const llmTraceRecorder = createLlmTraceRecorder({
        env: process.env,
        runId: params.runId,
        sessionId: activeSession.sessionId,
        sessionKey: params.sessionKey,
      ...
      activeSession.agent.streamFn = llmTraceRecorder.wrapStreamFn(activeSession.agent.streamFn);
