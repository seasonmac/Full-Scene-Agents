...
export class OpenClawApp extends LitElement {
  ...
  @state() tracingError: string | null = null;
  @state() tracingFile: string | null = null;
  @state() tracingEntries: LlmTraceSummary[] = [];
  @state() tracingFilterText = "";
  @state() tracingProviderFilter = "";
  @state() tracingStatusFilter: "all" | "ok" | "error" | "in_progress" = "all";
  @state() tracingAutoFollow = true;
  @state() tracingSortKey:
    | "time"
    | "name"
    | "status"
    | "tokens"
    ...
    | "input"
    | "output" = "time";
  @state() tracingSortDir: "asc" | "desc" = "desc";
  @state() tracingTruncated = false;
  @state() tracingCursor: number | null = null;
  @state() tracingLimit = 100;
  @state() tracingMaxBytes = 500_000;
  @state() tracingSelectedId: string | null = null;
  @state() tracingSelected: LlmTraceRecord | null = null;
  ...
  private tracesPollInterval: number | null = null;
